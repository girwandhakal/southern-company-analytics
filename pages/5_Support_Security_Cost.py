    ...
    with tab_risk:
        ...
        with left:
            ...
            render_plotly_with_download(
                fig_cost_stack,
                "cost_exposure_by_device_type_and_risk",
                "support_security_cost_exposure_by_device",
        ...
        with right:
            ...
            render_plotly_with_download(
                fig_support_donut,
                "support_coverage_distribution",
                "support_security_support_coverage_distribution",
                use_container_width=True,
                config=PLOTLY_CLEAN,
            )
        ...
        if debt_df.empty:
            ...
            render_plotly_with_download(
                fig_scatter,
                "technical_debt_matrix_cost_vs_days_unsupported",
                "support_security_technical_debt_matrix",
                use_container_width=True,
                config=PLOTLY_CLEAN,
            )
